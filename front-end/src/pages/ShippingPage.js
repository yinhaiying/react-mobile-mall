    ...
    <FormContainer>
      ...
      <Form>
        <Form.Group controlId="address">
          ...
          <Form.Control type="text" placeholder="请输入用户名" value={address} onChange={(e) => setAddress(e.target.value)} />
        </Form.Group>
        ...
        <Form.Group controlId="province">
          ...
          <Form.Control type="text" placeholder="请输入省份" value={province} onChange={(e) => setProvince(e.target.value)} />
        </Form.Group>
